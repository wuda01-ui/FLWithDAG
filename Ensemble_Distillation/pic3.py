...
df = pd.read_excel("./hhtest0.3.xlsx")
...
sns.lineplot(x = df["Communication Round"].tolist(), y = df["OURS"].tolist(), label='OURS', 
             linewidth=2.5, color="#c35241", linestyle = 'solid')
sns.lineplot(x = df["Communication Round"].tolist(), y = df["DENSE"].tolist(), label='DENSE', 
             linewidth=2.5, color="#147dbb", linestyle = 'dashed')
sns.lineplot(x = df["Communication Round"].tolist(), y = df["ADI"].tolist(), label='ADI', 
             linewidth=2.5, color="#e49440", linestyle = '--')
sns.lineplot(x = df["Communication Round"].tolist(), y = df["DAFL"].tolist(), label='DAFL', 
             linewidth=2.5, color="#318e5c", linestyle = '-.')
sns.lineplot(x = df["Communication Round"].tolist(), y = df["FedDF"].tolist(), label='FedDF', 
             linewidth=2.5, color="#8d8bbc", linestyle = 'dotted')
